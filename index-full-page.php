                                ...
                                <div class="de-flex-col">
                                    ...
                                    <ul id="mainmenu">
                                        ...
                                        <li>
                                            <a href="#">Rooms</a>
                                            <ul>
                                                <li><a href="rooms.html">2 Columns</a></li>
                                                <li><a href="02-room.html">3 Columns</a></li>
                                                <li><a href="room.html">Room Single</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-lg-4">
                            <div class="de-room">
                                ...
                                <div class="d-text">
                                    ...
                                    <a href="room.html" class="btn-line"><span>Book Now For $29</span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="de-room">
                                ...
                                <div class="d-text">
                                    <h3>Deluxe Room</h3>
                                    <p>Most hotels and major hospitality companies have set industry standards to classify hotel types. An upscale full-service hotel facility offers luxury...</p>
                                    <a href="room.html" class="btn-line"><span>Book Now For $39</span></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="de-room">
                                ...
                                <div class="d-text">
                                    <h3>Premier Room</h3>
                                    <p>Most hotels and major hospitality companies have set industry standards to classify hotel types. An upscale full-service hotel facility offers luxury...</p>
                                    <a href="room.html" class="btn-line"><span>Book Now For $49</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
