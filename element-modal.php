    ...
    <body>
        ...
        <div id="content-absolute">
                            ...
                            <div class="de-content-overlay">
                                <div class="row">
                                    <div class="col-md-4 mb60">
                                        ...
                                        <a class="btn-main" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                          Launch demo modal
                                        </a>
                                    ...
                                    <div class="col-md-4 mb60">
                                        ...
                                        <!-- Button trigger modal -->
                                        <a class="btn-main" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                          Launch demo modal
                                        </a>
                                    ...
                                    <div class="col-md-4 mb60">
                                        ...
                                        <!-- Button trigger modal -->
                                        <a class="btn-main" data-bs-toggle="modal" data-bs-target="#scrollingLongContent">
                                          Launch demo modal
                                        </a>            
                                    ...
                                    <div class="col-md-4 mb60">
                                        ...
                                        <!-- Button trigger modal -->
                                        <a class="btn-main" data-bs-toggle="modal" data-bs-target="#scrollableModal">
                                          Launch demo modal
                                        </a>
            ...
            <footer class="no-top pl20 pr20">
                <div class="subfooter">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">&copy; Copyright 2023 - Seaside Hotel by <span class="id-color">PixelCrafters</span></div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a class="btn-main" data-bs-dismiss="modal">Close</a>
                <a class="btn-main">Save changes</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="scrollingLongContent" data-bs-keyboard="false" tabindex="-1" aria-labelledby="scrollingLongContentLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="scrollingLongContentLabel">Scrolling long content</h5>
                <a class="btn-close" data-bs-dismiss="modal" aria-label="Close"></a>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a class="btn-main" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">Open second modal</a>
              </div>
            </div>
          </div>
        </div>
        <div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <a class="btn-main" data-bs-target="#exampleModalToggle" data-bs-toggle="modal" data-bs-dismiss="modal">Back to first</a>
              </div>
            </div>
          </div>
        </div> 
