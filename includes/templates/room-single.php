                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 order-1 order-md-2 mb-4 booking-column">
                                ...
                                <div class="booking-iframe-wrapper">
                                    <iframe id="booking-iframe" sandbox="allow-top-navigation allow-scripts allow-same-origin" src="" allowfullscreen loading="lazy" scrolling="no" class="booking-iframe-responsive">
                                    </iframe>
                                </div>
