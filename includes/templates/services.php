                    ...
                    <div id="content-absolute">
                        ...
                        <section
                            ...
                            <div class="container d-carousel">
                                <!-- Owl Carousel -->
                                    ...
                                    <!-- <div class="item">
                                        <div class="card-image-1 de-offer">
                                            <a href="comida.php" class="d-text">
                                                <div class="d-inner">
                                                    <h3>Gastronomía Yucateca</h3>
                                                    <p>
                                                        Degusta platillos tradicionales como cochinita pibil,
                                                        panuchos y sopa de lima en un ambiente acogedor.
                                                    </p>
                                                    <h5 class="d-tag">Comida</h5>
                                                </div>
                                            </a>
                                            <img
