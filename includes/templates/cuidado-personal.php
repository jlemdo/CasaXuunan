                ...
                <div class="container">
                        ...
                        <div class="col-md-8 offset-md-2 text-center">
                            ...
                            <div class="mb-4">
                                <a href="#section-packages" class="btn-main btn-lg">
                                    <i class="fa fa-gem mr-2"></i>Ver Servicios
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4 mb-5 justify-content-center">
                        ...
                        <div class="col-md-5">
                            <div class="feature-box feature-box-style-3 h-100">
                                <div class="feature-box-icon">
                                    <i class="fa fa-hand-sparkles id-color"></i>
                                </div>
                        ...
                        <div class="col-md-5">
                            <div class="feature-box feature-box-style-3 h-100">
                                <div class="feature-box-icon">
                                    <i class="fa fa-shoe-prints id-color"></i>
                                </div>
                                <div class="feature-box-info">
                            ...
                            <form id="whatsapp-form" class="contact-form">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <textarea id="comentarios" name="comentarios" class="form-control" rows="3" placeholder="¿Alguna preferencia de esmalte o detalle a considerar? (opcional)"></textarea>
                                    </div>
                                </div>
